...
\description{Computes the Horvitz-Thompson estimator of the population total according to a 2SI sampling design}
\usage{
...
\item{Ni}{Vector of population sizes of Secundary Sampling Units selected in the first draw}      
\item{ni}{Vector of sample sizes of Secundary Sampling Units}
...
\item{PSU}{Vector identifying the membership to the strata of each unit in the population}
}
\seealso{
\code{\link{S.SI}}
}
